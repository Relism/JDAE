...
/**
 * Lightweight builder used for nested annotation composition and standalone building.
 */
public class SimpleAnnotationBuilder implements AnnotationBuilder {
    private final AnnotationDescriptor.Builder builder;

    public SimpleAnnotationBuilder(String annotationClassName) {
